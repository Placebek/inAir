        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="p-6 border-b bg-gradient-to-r from-blue-50 to-indigo-50">
                ...
                <p className="text-sm text-gray-600 mt-2">
                    Найдено: <strong>{filteredInventory.length}</strong> из{" "}
                    <strong>{inventory.length}</strong> товаров
                </p>
            </div>
                        ...
                        {filteredInventory.length > 0 ? (
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    <p>
                                        Попробуйте изменить запрос или добавить
                                        новые товары
                                    </p>
                                </td>
                            </tr>
            ...
            {inventory.length > 20 && (
                <div className="px-6 py-4 bg-gray-50 border-t text-sm text-gray-600">
                    Показано {filteredInventory.length} из {inventory.length}{" "}
                    позиций
                </div>
            )}
        </div>
